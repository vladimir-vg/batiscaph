-module(ct_espace_steps_transform).
-export([parse_transform/2]).



%%% This parse_transform takes testcases with -espace_steps(). attribute
%%% and replaces their body with espace_shell call, with AST.
...
get_steps_attr_value([{attribute,_Line,espace_steps,Value} | _Forms]) -> {ok, Value};
