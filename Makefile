...
ct:
	BATISCAPH_CLICKHOUSE_DB=$(CLICKHOUSE_TEST_DB) BATISCAPH_CLICKHOUSE_URL=$(CLICKHOUSE_URL) BATISCAPH_NEO4J_HTTP_URL=$(NEO4J_HTTP_URL) BATISCAPH_NODE=$(BATISCAPH_NODE) ./rebar3 ct --sname ct_run
